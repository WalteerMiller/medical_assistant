                ...
                <div class="owl-carousel owl-theme reviews-holder">
                    ...
                    <div class="review-2">
                        <div class="review-txt text-center">
                            ...
                            <!-- Quote -->
                            <div class="quote"><img src="{{asset('assets/medService/images/quote.png')}}" alt="quote-img"></div>
                            <!-- Author Avatar -->
                            <div class="testimonial-avatar">
                                <img src="{{asset('assets/medService/images/review-author-6.jpg')}}" alt="testimonial-avatar">
                            </div>
                    ...
                    <div class="review-2">
                        <div class="review-txt text-center">
                            ...
                            <!-- Author Avatar -->
                            <div class="testimonial-avatar">
                                <img src="{{asset('assets/medService/images/review-author-7.jpg')}}" alt="testimonial-avatar">
                            </div>
                    ...
                    <div class="review-2">
                        <div class="review-txt text-center">
                            ...
                            <!-- Author Avatar -->
                            <div class="testimonial-avatar">
                                <img src="{{asset('assets/medService/images/review-author-8.jpg')}}" alt="testimonial-avatar">
                            </div>
                    ...
                    <div class="review-2">
                        <div class="review-txt text-center">
                            ...
                            <!-- Author Avatar -->
                            <div class="testimonial-avatar">
                                <img src="{{asset('assets/medService/images/review-author-9.jpg')}}" alt="testimonial-avatar">
                            </div>
